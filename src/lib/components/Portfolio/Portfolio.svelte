<section id="about-me" class="py-12 md:py-28">
	...
	<div
		class="mt-20 mx-auto flex w-full max-w-5xl flex-wrap items-center justify-between gap-x-6 gap-y-10 px-4 md:mt-36"
	>
